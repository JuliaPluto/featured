...
When given 3D data, we can visualize it by using **Heatmaps** or **3D graphs**.
...
When drawing a **contour** in the 3D graph for a certain value `k`, we cut our plot with a straight plane at height `k`. Any point that has a value at exactly this height will be highlighted on our heatmap in red.
...
# ╔═╡ 922fdf57-c9e0-44d5-bfa9-ab82100aa67b
...
git-tree-sha1 = "a92cc6b1fb1b6233818aab02e88293b07cf445e5"
