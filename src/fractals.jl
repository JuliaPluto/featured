...
#> date = "2024-07-21"
#> tags = ["fractals", "math", "julia"]
#> description = "Introduces fractals mathematically and teaches you to generate your own fractal art"
#> 
#>     [[frontmatter.author]]
#>     name = "Pluto"
...
im_axes = """
<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 300 300" style="max-width:100%;height:auto;color:black">
  <defs>
  ...
  <line x1="10" x2="290" y1="150" y2="150" stroke="currentColor" marker-start="url(#triangle)" marker-end="url(#triangle)"/>
  <line y1="10" y2="290" x1="150" x2="150" stroke="currentColor" marker-start="url(#triangle)" marker-end="url(#triangle)"/>
  ...
  <g style="    font-family: math;
    ...
    <g transform="translate(270, 150)">
      <line y1="-5" y2="5" stroke="currentColor"/>
    ...
    <g transform="translate(150, 30)">
      <line x1="-5" x2="5" stroke="currentColor"/>
...
svg_axes = im_axes |> SVG

# ╔═╡ 6233f626-19e9-4012-ba72-e9ca2386ab27
function ComplexNumberPicker()
 PlutoUI.Experimental.transformed_value(ImageCoordinatePicker(svg_axes)) do point
               if point === nothing
                  0.3 - im * 0.1 # Some default value for the first plot
            else
                 t(x) = (x - 150.0) / 120.0
