...
When given data that is defined over a tuple of values, i.e. if it is dependent on two variables (we'll call them x and y), we can visualize it by using **Heatmaps** or **3D graphs**.
...
countour_height = @bind contourH PlutoUI.Slider(-1:0.1:1, default=0, show_value=true)

# ╔═╡ fff5aad8-be03-4593-9056-c2f03ae70b8b
md"""
This is a **3D graph** next to a **Heatmap** of the same function!
"""

# ╔═╡ cd3be822-ad12-4495-bbcd-1857ec134ade
md"""
# Appendix
"""

# ╔═╡ d280f75b-354a-4465-8b5c-6fa609f0d8ed
len = 20

# ╔═╡ ab066c17-73e4-4895-8893-6fe981819dfb
x = range(-5, 5, length=len)

# ╔═╡ bb035028-23cd-45e8-910b-c83ead67e5ec
y = range(-5, 5, length=len)

# ╔═╡ 642e751f-4d36-4590-95d4-06d7d9ec780c
md"""
## Functions to plot
"""
...
# ╔═╡ e4ecc539-d8ef-4781-99f1-c74c2d43e011
@bind chosen_function Select([
	scaled_sphere => "Sphere",	
	((x,y) -> sin(sqrt(x^2 + y^2))) => "Sinus",
	ackley => "Ackley",
	goldstein_price => "Goldstein Price",
	scaled_levi => "Levi",
	hoelder_table => "Hölder Table"
])

# ╔═╡ 9d342353-85e5-4e41-911f-a36d0b79f469
...
begin
	...
	contour!(ax2,x,y,z;levels=[contourH],color=:red)
	f
end
