...
using MLJ, CSV, CairoMakie, PlutoUI, HTTP, Plots, OpenML, DataFrames, BetaML, GraphPlot, DecisionTree, MLJDecisionTreeInterface
...
# ╔═╡ 1cf798f1-7b68-4a69-a241-989b2c8bafab
begin
	dataset = OpenML.load(42638)
	df = DF.DataFrame(dataset)
	#selected_features = [:elevation, :aspect, :slope, :class]
	#df = table[:, selected_features]
end

# ╔═╡ 4e919049-cfca-4ede-a64a-73910456ae1a
DF.describe(df)

# ╔═╡ 68637433-8326-4e33-9234-c0f05d4beab6
schema(df)
...
begin 
	...
	y, X = unpack(df_train, ==(:survived), !=(:cabin));
	X = X[:, [:age, :sibsp, :fare]]
	...
	#DecisionTree.fit!(mach)

	#p = MLJ.predict(mach, X)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "7de999e5c38441fe6c87c16e0e7b4cc5d1a388bb"
